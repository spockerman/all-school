...
import Phone from "../../../../../../public/blood.png";
import SingleAtt from "../../../../../../public/singleAttendance.png";
import SingleBranches from "../../../../../../public/singleBranch.png";
                        ...
                        <div className="w-2/3 flex flex-col justify-between gap-4">
                            ...
                            <div className="flex items-center justify-between gap-2 flex-wrap text-xs font-medium">
                                <div className="w-full md:w-1/3 lg:w-full 2xl:w-1/3 flex items-center gap-2 ">
                                    <Image src={Blood} alt='' width={14} height={14}/>
                                    <span>A+</span>
                                </div>
                                <div className="w-full md:w-1/3 lg:w-full 2xl:w-1/3 flex items-center gap-2 ">
                                    <Image src={Date} alt='' width={14} height={14}/>
                                    <span>January 2025</span>
                                </div>
                                <div className="w-full md:w-1/3 lg:w-full 2xl:w-1/3 flex items-center gap-2 ">
                                    <Image src={Mail} alt='' width={14} height={14}/>
                                    <span>user@gmail.com</span>
                                </div>
                                <div className="w-full md:w-1/3 lg:w-full 2xl:w-1/3 flex items-center gap-2 ">
                                    <Image src={Phone} alt='' width={14} height={14}/>
                                    <span>+55 11 984577786</span>
                                </div>
